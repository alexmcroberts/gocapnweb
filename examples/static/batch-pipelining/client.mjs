...
import { newHttpBatchRpcSession } from 'https://unpkg.com/capnweb@latest/dist/index.js';
    ...
    try {
        ...
        outputEl.innerHTML = `
            <div class="config">
                ...
                <p><strong>Server:</strong> Go implementation of Cap'n Web RPC</p>
            </div>
        ...
        outputEl.innerHTML = `<div class="error">Error: ${err.message}<br><br>Make sure the Go server is running on port 8000.</div>`;
        console.error(err);
    }
}
